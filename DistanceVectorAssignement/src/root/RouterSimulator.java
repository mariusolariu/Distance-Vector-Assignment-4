...
public class RouterSimulator {
	...
	/*****************************************************************
	 ***************** NETWORK EMULATION CODE STARTS BELOW *********** The code below emulates
	 * the layer 2 and below network environment: - emulates the tranmission and
	 * delivery (with no loss and no corruption) between two physically
	 * connected nodes - calls the initializations routines rtinit0, etc., once
	 * before beginning emulation
	 * 
	 * THERE IS NOT REASON THAT ANY STUDENT SHOULD HAVE TO READ OR UNDERSTAND
	 * THE CODE BELOW. YOU SHOLD NOT TOUCH, OR REFERENCE (in your code) ANY OF
	 * THE DATA STRUCTURES BELOW. If you're interested in how I designed the
	 * emulator, you're welcome to look at the code - but again, you should not
		...
		while (true) {
			...
			if ( TRACE > 1 ) {
				...
				if ( eventptr.evtype == FROM_LAYER2 ) {
					...
					myGUI.println(", contents: " + eventptr.rtpktptr.mincost[0] + " " + eventptr.rtpktptr.mincost[1]
	...
	void toLayer2(RouterPacket packet) {
		...
		if ( TRACE > 2 ) {
			myGUI.print(
			        "    TOLAYER2: source: " + mypktptr.sourceid + " dest: " + mypktptr.destid + "             costs:");
